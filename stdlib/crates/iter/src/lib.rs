...
impl IterModule {
    ...
    #[stdlib_export(params(values: List), returns = List, kind = "full_state")]
    ...
    #[stdlib_export(params(values: List, count: Int), returns = List, kind = "full_state")]
    ...
    #[stdlib_export(params(values: List, size: Int), returns = List, kind = "full_state")]
