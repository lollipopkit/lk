    ...
    fn runtime_exports(&self) -> Result<RuntimeExport> {
        Ok(lk_stdlib_common::stdlib_runtime_exports!(
            [
                ...
                plain "write" => write, 2,
                plain "append" => append, 2,
                plain "exists" => exists, 1,
                plain "is_file" => is_file, 1,
                plain "is_dir" => is_dir, 1,
                plain "metadata" => file_metadata, 1,
                plain "read_dir" => read_dir, 1,
                plain "create_dir" => create_dir, 1,
                plain "create_dir_all" => create_dir_all, 1,
                plain "remove_file" => remove_file, 1,
                plain "remove_dir" => remove_dir, 1,
                plain "remove_dir_all" => remove_dir_all, 1,
                plain "rename" => rename, 2,
                plain "copy" => copy, 2,
                plain "canonicalize" => canonicalize, 1,
                plain "temp_dir" => temp_dir, 0,
            ],
        ))
    }
}
...
fn read(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 1, "fs.read()")?;
...
fn read_to_string(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 1, "fs.read_to_string()")?;
...
fn write(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 2, "fs.write()")?;
...
fn append(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    ...
    lk_stdlib_common::runtime_native::expect_arity(args, 2, "fs.append()")?;
...
fn exists(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 1, "fs.exists()")?;
...
fn is_file(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 1, "fs.is_file()")?;
...
fn is_dir(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 1, "fs.is_dir()")?;
...
fn file_metadata(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 1, "fs.metadata()")?;
...
fn read_dir(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 1, "fs.read_dir()")?;
...
fn create_dir(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 1, "fs.create_dir()")?;
...
fn create_dir_all(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 1, "fs.create_dir_all()")?;
...
fn remove_file(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 1, "fs.remove_file()")?;
...
fn remove_dir(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 1, "fs.remove_dir()")?;
...
fn remove_dir_all(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 1, "fs.remove_dir_all()")?;
...
fn rename(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 2, "fs.rename()")?;
...
fn copy(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 2, "fs.copy()")?;
...
fn canonicalize(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 1, "fs.canonicalize()")?;
...
fn temp_dir(args: NativeArgs<'_>, runtime: &mut NativeRuntime<'_>) -> Result<RuntimeVal> {
    lk_stdlib_common::runtime_native::expect_arity(args, 0, "fs.temp_dir()")?;
