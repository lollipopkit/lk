...
pub use lkdyn::{
    ...
    lkrt_dyn_ge, lkrt_dyn_gt, lkrt_dyn_index, lkrt_dyn_le, lkrt_dyn_len_of, lkrt_dyn_lt, lkrt_dyn_method_missing,
    lkrt_dyn_mod, lkrt_dyn_mul, lkrt_dyn_not, lkrt_dyn_obj_type_id, lkrt_dyn_sub, lkrt_dyn_tag, lkrt_dyn_truthy,
