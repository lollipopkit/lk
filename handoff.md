...
- FFI 增强:✅ ergonomic Value 转换层(双向)· ✅ 高层 host fn `register_fn_v`
  · ✅ `register_module` 命名空间(2026-07-16,progress.md「FFI ergonomic」)。
  剩 rooted handle(复用 #22 host_roots,最 niche)。
- M2.6 内存上限(fuel 已有)。
