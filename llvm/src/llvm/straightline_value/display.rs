...
pub(super) fn native_builtin_display(builtin: NativeBuiltin) -> String {
    let (name, arity) = match builtin {
        ...
        NativeBuiltin::Assert => ("assert", None),
        NativeBuiltin::AssertEq => ("assert_eq", None),
        NativeBuiltin::AssertNe => ("assert_ne", None),
        ...
        NativeBuiltin::BytesToStringUtf8 => ("to_string_utf8", Some(1)),
        ...
        NativeBuiltin::EnvGetOr => ("get_or", Some(2)),
        NativeBuiltin::FsExists => ("exists", Some(1)),
        NativeBuiltin::FsReadDir => ("read_dir", Some(1)),
        NativeBuiltin::FsTempDir => ("temp_dir", Some(0)),
        NativeBuiltin::FibIterative => ("iterative", Some(1)),
        NativeBuiltin::GreetingsMessage => ("message", Some(1)),
        NativeBuiltin::IoStdFlush => ("flush", Some(1)),
        NativeBuiltin::IoStdReadToString => ("read_to_string", Some(1)),
        NativeBuiltin::IoStdStderr => ("stderr", Some(0)),
        NativeBuiltin::IoStdStdin => ("stdin", Some(0)),
        NativeBuiltin::IoStdStdout => ("stdout", Some(0)),
        NativeBuiltin::IoStdWrite => ("write", Some(2)),
        NativeBuiltin::IoStdWriteln => ("writeln", Some(2)),
        ...
        NativeBuiltin::PathSep => ("sep", Some(0)),
        NativeBuiltin::ProcessCwd => ("cwd", Some(0)),
        NativeBuiltin::SocketAddr => ("addr", Some(2)),
        NativeBuiltin::TcpClose => ("close", Some(1)),
        NativeBuiltin::TcpConnect => ("connect", Some(1)),
        NativeBuiltin::TcpRead => ("read", Some(2)),
