...
use crate::vm::{RuntimeExport32, RuntimeModuleState32, copy_runtime_value, import_runtime_export};
...
fn import_runtime_export_copies_mixed_map_object_keys_into_destination_heap() {
    ...
    let state = Arc::new(Mutex::new(RuntimeModuleState32::new(source_heap, Vec::new())));
    let export = RuntimeExport32::new(RuntimeVal::Obj(map), Arc::clone(&state), Arc::new(Module32::default()));
