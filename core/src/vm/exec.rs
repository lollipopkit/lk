...
impl Executor {
    ...
    #[cold]
    pub(in crate::vm::exec) fn call_depth_exceeded(&mut self) -> Result<()> {
        #[cfg(feature = "std")]
    ...
    #[inline]
    pub(in crate::vm::exec) fn consume_instruction(&mut self) -> Result<()> {
    ...
    pub(in crate::vm::exec) fn dispatch_within_frame<const BUDGETED: bool>(
        &mut self,
        function: &Function,
