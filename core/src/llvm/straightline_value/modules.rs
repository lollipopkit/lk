...
pub(super) fn native_static_module_index(
    ...
    match (module, key.as_str()) {
        ...
        (NativeModule::Io, "stderr_writeln") => Some(NativeStraightlineValue::Builtin(NativeBuiltin::IoStderrWriteln)),
        (NativeModule::Io, "stdout_flush") => Some(NativeStraightlineValue::Builtin(NativeBuiltin::IoStdoutFlush)),
        (NativeModule::Io, "stderr_flush") => Some(NativeStraightlineValue::Builtin(NativeBuiltin::IoStderrFlush)),
